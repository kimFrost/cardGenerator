 ...
 * 
 * MAC: Modified output markup to include extra wrapping element needed for absolute centering
 * 
 */
					...
					performCloseDialog: function ($dialog, value) {
						...
						if (animationEndSupport) {
							$dialog.unbind(animationEndEvent).bind(animationEndEvent, function () {
								//MAC: Commented line - causes issues with ngAnimate
					...
					open: function (opts) {
						...
						$q.when(loadTemplate(options.template || options.templateUrl)).then(function (template) {
							...
							if (options.showClose) {
								template += '<button class="ngdialog-close" role="button" autofocus></button>';
							}
							...
							//MAC: New line
							$dialog.html('<div class="ngdialog-centering-outer"><div class="ngdialog-centering-inner ngdialog-overlay"><div class="ngdialog-content">' + template + '</div></div></div>');
